			...
			<div class="center_box">
						...
						<div class="calendar_box_content">
							...
							<img src="images/contact_icon.gif" alt="" title="">
								<p class="contact_info">
									<span class="orange">Adress:</span> H-109,Shakarpur<br> <span
										class="orange">Telephone:</span> 0123456789<br> <span
											class="orange">Email:</span> <a
											href="xyz@facebook.com">info@company.com</a><br>
								</p>
						</div>
					</div>
				...
				<div class="right_content">
					...
					<div class="project_box">
						<a href="#"><img src="images/clients_icon.gif" alt="" title=""
